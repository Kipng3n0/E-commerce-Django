...
def customer_address_view(request):
    ...
    # if there is no product in cart it will not show address form
    ...
    if request.method == 'POST':
        ...
        if addressForm.is_valid():
            ...
            # not taking it from customer account table because
...
def payment_success_view(request):
    ...
    # placing number of orders as much there is a products
    # suppose there is 5 items in cart and we place order....so 5 rows will be created in orders table
